...
# Geocoder::Configuration.timeout = 0.1
...
Geocoder::Configuration.always_raise = [SocketError, TimeoutError, Geocoder::OverQueryLimitError] #<< Geocoder::OverQueryLimitError